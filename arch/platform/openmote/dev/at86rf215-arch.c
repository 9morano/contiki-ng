...
#define AT86RF215_TEST_PORT_BASE      GPIO_PORT_TO_BASE(GPIO_C_NUM)
#define AT86RF215_TEST_PIN_MASK       GPIO_PIN_MASK(3)
/*---------------------------------------------------------------------------*/
...
at86rf215_arch_init(void)
{
    ...
    /* Initialize GPIO pins for external antenna array element selection */
    GPIO_SOFTWARE_CONTROL(GPIO_PORT_TO_BASE(UCA_CTR_PORT), GPIO_PIN_MASK(UCA_CTRL_1_1_PIN));
    GPIO_SET_OUTPUT(GPIO_PORT_TO_BASE(UCA_CTR_PORT), GPIO_PIN_MASK(UCA_CTRL_1_1_PIN));

    GPIO_SOFTWARE_CONTROL(GPIO_PORT_TO_BASE(UCA_CTR_PORT), GPIO_PIN_MASK(UCA_CTRL_1_2_PIN));
    GPIO_SET_OUTPUT(GPIO_PORT_TO_BASE(UCA_CTR_PORT), GPIO_PIN_MASK(UCA_CTRL_1_2_PIN));

    GPIO_SOFTWARE_CONTROL(GPIO_PORT_TO_BASE(UCA_CTR_PORT), GPIO_PIN_MASK(UCA_CTRL_2_1_PIN));
    GPIO_SET_OUTPUT(GPIO_PORT_TO_BASE(UCA_CTR_PORT), GPIO_PIN_MASK(UCA_CTRL_2_1_PIN));

    GPIO_SOFTWARE_CONTROL(GPIO_PORT_TO_BASE(UCA_CTR_PORT), GPIO_PIN_MASK(UCA_CTRL_2_2_PIN));
    GPIO_SET_OUTPUT(GPIO_PORT_TO_BASE(UCA_CTR_PORT), GPIO_PIN_MASK(UCA_CTRL_2_2_PIN));

    /* Initialize GPIO pin for testing purposes */
    GPIO_SOFTWARE_CONTROL(AT86RF215_TEST_PORT_BASE, AT86RF215_TEST_PIN_MASK);
    GPIO_SET_OUTPUT(AT86RF215_TEST_PORT_BASE, AT86RF215_TEST_PIN_MASK);
    //GPIO_SET_PIN(AT86RF215_TEST_PORT_BASE, AT86RF215_TEST_PIN_MASK);
}
